...
int main() {
    ...
    fs::path sourceDirectory = "C:\\Users\\johnworker\\Desktop\\Проекты C++\\Sort your photos\\TestPhotos";

    // Указываем папку для сортировки (куда будут перемещаться фото)
    fs::path targetDirectory = "C:\\Users\\johnworker\\Desktop\\Проекты C++\\Sort your photos\\SortedPhotos";
