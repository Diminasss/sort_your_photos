#include "sort_front.h"
#include "./ui_sort_front.h"
...
FileSendWidget::FileSendWidget(QWidget *parent) : QWidget(parent) {
    ...
    // Path label 2
    QLabel *pathLabel2 = new QLabel("Укажите путь к папке, в которую хотите установить:", this);
    pathLabel2->setStyleSheet("font-size: 14px; color: black;");
    QLineEdit *pathEdit2 = new QLineEdit(this);
    pathEdit2->setPlaceholderText("Specify the path...");
